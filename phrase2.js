...
var vowels = function () 
{
	...
	else
	{
        ...
        {
            if (stringEntry.charAt(intCount)==="A" || stringEntry.charAt(intCount)==="O" || stringEntry.charAt(intCount)==="E" || stringEntry.charAt(intCount)==="I" || stringEntry.charAt(intCount)==="U")
            {
                intVowels++;
            }
        }
