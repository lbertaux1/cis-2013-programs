...
{
    var stringPassword, arrayBadPasswords, stringOutput, intCounter;
  ...
  if (stringPassword.length < 8)
    {
        stringOutput="You entered an incorrect password.";
    }
    else
    {
        for (intCounter=0; intCounter < arrayBadPasswords.length; intCounter++)
        {
          //if input is included in bad password list, show error.
            if (stringPassword === arrayBadPasswords[intCounter])
            {
                stringOutput="Oops, you picked a bad password.";
            }
            else
            {
              //password is good.
              stringOutput = "Congrats! You've picked a good password.";
            }
            
        }
    }
    //pass value back to DOM
