...
function rectangleArea(floatRectWidth,floatRectHeight)
{
  var floatArea = parseFloat (floatRectWidth * floatRectHeight);
  return floatArea.toFixed(2);
}
...
var calcRectanglePerimeter = function ()
{
  ...
  alert ("The rectangle perimeter is " + rectanglePerimeter(floatRectWidth,floatRectHeight));
};

function rectanglePerimeter(floatRectWidth,floatRectHeight)
{
  var floatPerimeter = parseFloat (2 * floatRectWidth + 2 * floatRectHeight);
...
var calcTriangleArea = function ()
{
  ...
  alert ("The triangle area is " + triangleArea(floatS,floatTriSide1,floatTriSide2,floatTriSide3));
};

function triangleArea(floatS,floatTriSide1,floatTriSide2,floatTriSide3)
{
  var floatS = (floatTriSide2 + floatTriSide2 + floatTriSide3)/2;
  var floatArea = parseFloat (Math.sqrt((floatS*(floatS-floatTriSide1)*(floatS-floatTriSide2)*(floatS-floatTriSide3))));
  return floatArea.toFixed(2);
}
...
var calcTrianglePerim = function ()
{
  ...
  alert ("The triangle perimeter is " + trianglePerimeter(floatTriSide1,floatTriSide2,floatTriSide3));
};

function trianglePerimeter(floatTriSide1,floatTriSide2,floatTriSide3)
{
  var floatArea = parseFloat (floatTriSide1 + floatTriSide2 + floatTriSide3);
  return floatArea.toFixed(2);
}
...
//    $("radius").value = "";
    ...
    $("calc_rect_area").onclick = calcRectangleArea;
    $("calc_rect_perim").onclick = calcRectanglePerimeter;
